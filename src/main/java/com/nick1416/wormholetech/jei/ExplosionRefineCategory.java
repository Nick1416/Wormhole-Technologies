...
public class ExplosionRefineCategory implements IRecipeCategory<ExplosionRefineWrapper> {
    ...
    public static final String UID = WormholeTech.MODID + ".explosion_refine";
    ...
    @Override public String getTitle() { return I18n.format("jei.wormholetech.explosion_refine"); }
