...
public class ExplosionRefineWrapper implements IRecipeWrapper {
    ...
    public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
        minecraft.fontRenderer.drawString(I18n.format("jei.wormholetech.explosion_refine.hint"), 2, 2, 0x444444);
    }

    @Override
    public List<String> getTooltipStrings(int mouseX, int mouseY) {
        if (mouseY < 14) {
            return Collections.singletonList(I18n.format("jei.wormholetech.explosion_refine.tooltip"));
        }
