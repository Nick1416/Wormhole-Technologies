...
public class OreDropCategory implements IRecipeCategory<OreDropWrapper> {

    public static final String UID = WormholeTech.MODID + ".ore_drop";

    private final IDrawable background;
    private final IDrawable icon;

    public OreDropCategory(IGuiHelper guiHelper) {
        this.background = guiHelper.createBlankDrawable(120, 40);
        this.icon = guiHelper.createDrawableIngredient(new ItemStack(Registration.NAQUADAH_ORE));
    }

    @Override public String getUid() { return UID; }
    @Override public String getTitle() { return I18n.format("jei.wormholetech.ore_drop"); }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, OreDropWrapper recipeWrapper, IIngredients ingredients) {
