...
public class GuiWormholeDuplicator extends GuiContainer {
    ...
    private static final ResourceLocation BG =
            new ResourceLocation("wormholetech", "textures/gui/wormhole_duplicator.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        String title = I18n.format(unstable
                ? "container.wormholetech.unstable_wormhole_duplicator"
                : "container.wormholetech.wormhole_duplicator");
        ...
        switch (hovered.slotNumber) {
            case 0:
                lines = Arrays.asList(I18n.format(unstable
                        ? "gui.wormholetech.slot.fuel_diamond"
                        : "gui.wormholetech.slot.fuel_nugget"));
                break;
            case 1:
                lines = Arrays.asList(I18n.format("gui.wormholetech.slot.template.hint"));
                break;
            case 2:
                lines = Arrays.asList(I18n.format("gui.wormholetech.slot.output"));
                break;
            default:
                return;
        }
