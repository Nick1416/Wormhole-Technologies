...
public class GuiHighEnergyRefiner extends GuiContainer {
    ...
    private static final ResourceLocation BG =
            new ResourceLocation("rfgen", "textures/gui/high_energy_refiner.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        String title = I18n.format("container.rfgen.high_energy_refiner");
        ...
        String progress = I18n.format("gui.rfgen.progress_percent", container.getClientProgress());
