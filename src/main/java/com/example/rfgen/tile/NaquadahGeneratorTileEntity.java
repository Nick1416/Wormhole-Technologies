...
public class NaquadahGeneratorTileEntity extends TileEntity implements ITickable {
    ...
    private static final int RATE_PER_TICK = 5000;      // 5000 RF/t
    private static final int BUFFER = 500_000;
    private static final int MAX_EXTRACT = 5000;

    // 10 minutes real-time at 20 tps
    public static final int LIFETIME_TICKS = 12_000;
