...
public class DuplicationRecipeCategory implements IRecipeCategory<DuplicationRecipeWrapper> {
    ...
    public static final String UID = RFGen.MODID + ".duplication";
    private static final ResourceLocation BG =
            new ResourceLocation(RFGen.MODID, "textures/gui/wormhole_duplicator.png");
    ...
    public String getTitle() {
        return I18n.format("jei.rfgen.duplication");
    }
